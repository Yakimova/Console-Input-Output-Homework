...
class Rocks
{
    ...
    static void Main()
    {
        ...
        while (true)
        {
            ...
            // information
            PrintStringOnPossition(24, 2, "Lives: " + lives, ConsoleColor.White);
            PrintStringOnPossition(24, 4, "Level: " + level, ConsoleColor.Green);
...
// Thanks to Niki and his video https://www.youtube.com/watch?v=bQexyufgclY